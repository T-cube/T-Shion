...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BlackListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:[NSString stringWithUTF8String:object_getClassName([BlackListTableViewCell class])] forIndexPath:indexPath];
...
- (UITableView *)table {
    if (!_table) {
        ...
        [_table registerClass:[BlackListTableViewCell class] forCellReuseIdentifier:[NSString stringWithUTF8String:object_getClassName([BlackListTableViewCell class])]];
    }
    return _table;
}
